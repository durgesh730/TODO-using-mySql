    ...
    return (
        <div id="myModal" class="modal">
            <div class="modal-content mx-auto">
                ...
                <div className='inputs col-9 mx-auto mt-4'>
                ...
                <div className="textarea col-9 my-4 mx-auto">
                    <input type="title" className="form-control" id="title" value={input.description} onChange={(e) => setInput((pre) => ({ ...pre, description: e.target.value }))}
